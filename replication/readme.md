To replicate the results in the paper, you will need to install the mhtexp2 package, and download the replication files for Karlan and List (2007). Instructions:
